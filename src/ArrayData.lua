...
CopyDariRidAsli = MemoryCopy(Rid_Asli, scid_asli)
const'CopyDariRidAsli'

DATA_RID = 
{
	{"Instant Spoof",0};
	{"RID Asli",CopyDariRidAsli};
	{"Synchweizher",158451613};
	{"YonataSP",134757642};
	{"Dea_Fi",118756001};
	{"swegley",171225995};
	{"Leakess",177107411};
	...
	{"PapaCabut",159148187};
	{"Gyoza_Lion", 163456297};
	{"DuoPanda02", 144601776};
	{"Uniqueklo", 157887587};
	{"B4nZ014", 129880678};
	{"fadlan23",100451566};
	...
	{"keripotter",158227943};
	{"Gia_Yoka",170252865};
	{"LittleMira",181011600};
	{"IrvanMacon",152831517};
	{"DutaTakDeAkhlak ",162525610};
	{"Assistant_Akali",156422602};
	{"EvroG1",160132903};
	{"Spongeb0b",156350140};
	{"Entercaps",135888882};
	{"DE-ELGHI",85572123};
...
CT = 
{
	...
	{'Global RP Correction','Global RP Correction'};
...
VehOption = 
{
	...
	"Flying Car",
	"Jumps Flag Script",
	"Parachute Flag Script",
	"Infinites Vehicle Missiles",
	"Destroy All Car",
	"All Car Heals",
	"Destroy NPC Car",
	"Destroy Enemy Car",
	"Deluxo Hover Speed",
	"Superspeed",
	"Oppressor Flag Script",
	"Selling Cooldown Reset",
	"Engine Toggle Script",
	"Infinite Boost On Key"
}
...
ReportStat = {
	...
	{'MPPLY_OVERALL_CHEAT',0};
	{'MPPLY_OVERALL_BADSPORT',0};
	{'MPPLY_IS_HIGH_EARNER',0};
	{'MPPLY_IS_CHEATER',0};
	{'MPPLY_IS_BADSPORT',0}
...
apartment_1 = {{'MP1_HEIST_PLANNING_STAGE',-1}}

TypeOfAddress = {'Addr Byte','Addr Short','Addr Int','Addr Long','Addr Float','Addr Double','Addr String','Addr AOB'}

Global_Type = {'Global Editor Int','Global Editor Float', 'Global Editor Str'}

Local_Type = {'Local Int 32','Local Int 64','Local Float','Local String'}
...
tbl_Properties={ }; 
--[[ tbl_Properties[PropID]={"Property Address (String)","Tuneable(Number/Table)/Price(String)"}]]
tbl_Properties[1]={ "Eclipse Towers, Apt 31",3949 }
tbl_Properties[2]={ "Eclipse Towers, Apt 9",3950 }
tbl_Properties[3]={ "Eclipse Towers, Apt 40",3951 }
tbl_Properties[4]={ "Eclipse Towers, Apt 5",3952 }
tbl_Properties[5]={ "3 Alta St, Apt 10",3953 }
tbl_Properties[6]={ "3 Alta St, Apt 57",3954 }
tbl_Properties[7]={ "Del Perro Heights, Apt 20",3955 }
tbl_Properties[8]={ "1162 Power St, Apt 3",3966 }
tbl_Properties[9]={ "0605 Spanish Ave, Apt 1",3967 }
tbl_Properties[10]={ "0604 Las Lagunas Blvd, Apt 4",3968 }
tbl_Properties[11]={ "0184 Milton Rd, Apt 13",3969 }
tbl_Properties[12]={ "The Royale, Apt 19",3970 }
tbl_Properties[13]={ "0504 S Mo Milton Dr",3971 }
tbl_Properties[14]={ "0115 Bay City Ave, Apt 45",3972 }
tbl_Properties[15]={ "0325 South Rockford Dr",3973 }
tbl_Properties[16]={ "Dream Tower, Apt 15",3974 }
tbl_Properties[17]={ "2143 Las Lagunas Blvd, Apt 9",3975 }
tbl_Properties[18]={ "1561 San Vitas St, Apt 2",3976 }
tbl_Properties[19]={ "0112 S Rockford Dr, Apt 13",3977 }
tbl_Properties[20]={ "2057 Vespucci Blvd, Apt 1",3978 }
tbl_Properties[21]={ "0069 Cougar Ave, Apt 19",3979 }
tbl_Properties[22]={ "1237 Prosperity St, Apt 21",3980 }
tbl_Properties[23]={ "1115 Blvd Del Perro, Apt 18",3981 }
tbl_Properties[24]={ "0120 Murrieta Heights",3982 }
tbl_Properties[25]={ "Unit 14 Popular St",3983 }
tbl_Properties[26]={ "Unit 2 Popular St",3984 }
tbl_Properties[27]={ "331 Supply St",3985 }
tbl_Properties[28]={ "Unit 1 Olympic Fwy",3986 }
tbl_Properties[29]={ "0754 Roy Lowenstein Blvd",3987 }
tbl_Properties[30]={ "12 Little Bighorn Ave",3988 }
tbl_Properties[31]={ "Unit 124 Popular St",3989 }
tbl_Properties[32]={ "0552 Roy Lowenstein Blvd",3990 }
tbl_Properties[33]={ "0432 Davis Ave",3991 }
tbl_Properties[34]={ "Del Perro Heights, Apt 7",3956 }
tbl_Properties[35]={ "Weazel Plaza, Apt 101",3957 }
tbl_Properties[36]={ "Weazel Plaza, Apt 70",3958 }
tbl_Properties[37]={ "Weazel Plaza, Apt 26",3959 }
tbl_Properties[38]={ "4 Integrity Way, Apt 30",3960 }
tbl_Properties[39]={ "4 Integrity Way, Apt 35",3961 }
tbl_Properties[40]={ "Richards Majestic, Apt 4",3962 }
tbl_Properties[41]={ "Richards Majestic, Apt 51",3963 }
tbl_Properties[42]={ "Tinsel Towers, Apt 45",3964 }
tbl_Properties[43]={ "Tinsel Towers, Apt 29",3965 }
tbl_Properties[44]={ "142 Paleto Blvd",3992 }
tbl_Properties[45]={ "1 Strawberry Ave",3993 }
tbl_Properties[46]={ "1932 Grapeseed Ave",3994 }
tbl_Properties[47]={ "1920 Senora Way",3995 }
tbl_Properties[48]={ "2000 Great Ocean Highway",3996 }
tbl_Properties[49]={ "197 Route 68",3997 }
tbl_Properties[50]={ "870 Route 68 Approach",3998 }
tbl_Properties[51]={ "1200 Route 68",3999 }
tbl_Properties[52]={ "8754 Route 68",4000 }
tbl_Properties[53]={ "1905 Davis Ave",4001 }
tbl_Properties[54]={ "1623 South Shambles St",4002 }
tbl_Properties[55]={ "4531 Dry Dock St",4003 }
tbl_Properties[56]={ "1337 Exceptionalists Way",4004 }
tbl_Properties[57]={ "Unit 76 Greenwich Parkway",4005 }
tbl_Properties[58]={ "Garage Innocence Blvd",4006 }
tbl_Properties[59]={ "634 Blvd Del Perro",4007 }
tbl_Properties[60]={ "0897 Mirror Park Blvd",4008 }
tbl_Properties[61]={ "Eclipse Towers, Apt 3",6495 }
tbl_Properties[62]={ "Del Perro Heights, Apt 4",6496 }
tbl_Properties[63]={ "Richards Majestic, Apt 2",6497 }
tbl_Properties[64]={ "Tinsel Towers, Apt 42",6498 }
tbl_Properties[65]={ "4 Integrity Way, Apt 28",6499 }
tbl_Properties[66]={ "4 Hangman Ave",7716 }
tbl_Properties[67]={ "12 Sustancia Rd",7717 }
tbl_Properties[68]={ "4584 Procopio Dr",7718 }
tbl_Properties[69]={ "4401 Procopio Dr",7719 }
tbl_Properties[70]={ "0232 Paleto Blvd",7720 }
tbl_Properties[71]={ "140 Zancudo Ave",7721 }
tbl_Properties[72]={ "1893 Grapeseed Ave",7722 }
tbl_Properties[73]={ "3655 Wild Oats Drive",12731 }
tbl_Properties[74]={ "2044 North Conker Avenue",12732 }
tbl_Properties[75]={ "2868 Hillcrest Avenue",12733 }
tbl_Properties[76]={ "2862 Hillcrest Avenue",12734 }
tbl_Properties[77]={ "3677 Whispymound Drive",12735 }
tbl_Properties[78]={ "2117 Milton Road",12736 }
tbl_Properties[79]={ "2866 Hillcrest Avenue",12737 }
tbl_Properties[80]={ "2874 Hillcrest Avenue",12738 }
tbl_Properties[81]={ "2113 Mad Wayne Thunder Drive",12739 }
tbl_Properties[82]={ "2045 North Conker Avenue",12740 }
tbl_Properties[83]={ "Eclipse Towers, Penthouse Suite 1",12728 }
tbl_Properties[84]={ "Eclipse Towers, Penthouse Suite 2",12729 }
tbl_Properties[85]={ "Eclipse Towers, Penthouse Suite 3",12730 }
tbl_Properties[86]={ "Private Yacht","27000000" }
tbl_Properties[87]={ "Lombank West",15310 }
tbl_Properties[88]={ "Maze Bank West",15311 }
tbl_Properties[89]={ "Arcadius Business Center",15312 }
tbl_Properties[90]={ "Maze Bank Tower",15313 }
tbl_Properties[91]={ "Rancho Clubhouse",17393 }
tbl_Properties[92]={ "Del Perro Beach Clubhouse",17395 }
tbl_Properties[93]={ "Pillbox Hill Clubhouse",17391 }
tbl_Properties[94]={ "Great Chaparral Clubhouse",17400 }
tbl_Properties[95]={ "Paleto Bay Clubhouse",17397 }
tbl_Properties[96]={ "Sandy Shores Clubhouse",17399 }
tbl_Properties[97]={ "La Mesa Clubhouse",17392 }
tbl_Properties[98]={ "Downtown Vinewood Clubhouse",17390 }
tbl_Properties[99]={ "Hawick Clubhouse",17389 }
tbl_Properties[100]={ "Grapeseed Clubhouse",17398 }
tbl_Properties[101]={ "Paleto Bay Clubhouse",17396 }
tbl_Properties[102]={ "Vespucci Beach Clubhouse",17394 }
tbl_Properties[103]={ "Office Garage 1",19057 }
tbl_Properties[104]={ "Office Garage 2",18950 }
tbl_Properties[105]={ "Office Garage 3",18951 }
tbl_Properties[106]={ "Office Garage 1",19057 }
tbl_Properties[107]={ "Office Garage 2",18950 }
tbl_Properties[108]={ "Office Garage 3",18951 }
tbl_Properties[109]={ "Office Garage 1",19057 }
tbl_Properties[110]={ "Office Garage 2",18950 }
tbl_Properties[111]={ "Office Garage 3",18951 }
tbl_Properties[112]={ "Office Garage 1",19057 }
tbl_Properties[113]={ "Office Garage 2",18950 }
tbl_Properties[114]={ "Office Garage 3",18951 }
tbl_Properties[115]={ "Warehouse","3000000" }
tbl_Properties[116]={ "Hangar",Hangars={21975,21976,21977,21978,21979} }
tbl_Properties[117]={ "Facility",Facilities={23285,23286,23287,23288,23289,23290,23291,23292,23293} }
tbl_Properties[118]={ "Nightclub Service Entrance",Nightclubs={24151,24152,24153,24154,24155,24156,24157,24158,24159,24160} }
tbl_Properties[119]={ "Nightclub Garage B2",24165 }
tbl_Properties[120]={ "Nightclub Garage B3",24166 }
tbl_Properties[121]={ "Nightclub Garage B4",24167 }
tbl_Properties[122]={ "Arena Workshop","995000-3250000" }
tbl_Properties[123]={ "Arena Workshop B1","195000-590000" }
tbl_Properties[124]={ "Arena Workshop B2","265000-660000" }
tbl_Properties[125]={ "Casino Penthouse Garage",25837 }
...
"chinese2", 
"chop", 
"clothes_shop_mppilot_school", 
"clothes_shop_sppilot_school_mp", 
"code_controller", 
"combat_test", 
"comms_controller", 
...
"fairgroundhub", 
"fake_interiors", 
"fame_or_shame_setre_muggings", 
"fameorshame_eps", 
"fameorshame_eps_1re_mountdance", 
"family1re_paparazzi", 
"family1taxire_prison", 
"family2re_prisonerlift", 
"family3re_prisonvanbreak", 
"family4re_rescuehostage", 
"family5re_seaplane", 
"family6re_securityvan", 
"family_scene_f0", 
"family_scene_f1", 
"family_scene_m", 
"family_scene_t0", 
